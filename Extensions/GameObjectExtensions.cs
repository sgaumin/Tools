...
public static class GameObjectExtensions
{
	...
	{
		gameObject.GetAllComponents<SpriteRenderer>()?.ForEach(x => x.color = x.color.WithAlpha(0f));
		gameObject.GetAllComponents<Image>()?.ForEach(x => x.color = x.color.WithAlpha(0f));
		gameObject.GetAllComponents<TextMeshPro>()?.ForEach(x => x.color = x.color.WithAlpha(0f));
		gameObject.GetAllComponents<TextMeshProUGUI>()?.ForEach(x => x.color = x.color.WithAlpha(0f));
